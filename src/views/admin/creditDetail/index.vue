<template>
  <div class="member">
    ...
    >
      ...
      <el-table-column :label="$t('UserName')" align="center" prop="userName" sortable>
      </el-table-column>
      <el-table-column
        :label="$t('AddcreditLimit')"
        align="center"
        prop="creditLimit"
        sort-by="creditLimit"
        sortable
  ...
  methods: {
    ...
    getList() {
      ...
      if (this.searchFrom.fromDate && this.searchFrom.toDate) {
        ...
        this.butLoading = false
        this.$message({ type: "info", message: "Please select a start/end time" });
      }
    },
  },
};
